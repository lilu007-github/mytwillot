...
export interface Tweet extends TweetQuoted {
  ...
  ai_summary?: string
  // AI-extracted keyword tags, merged into note `tags:` frontmatter. Kept
  // separate from the user's curated colored `tags`.
  ai_tags?: string[]
  sort_index: string
  has_image: boolean
  has_video: boolean
...
export enum Endpoint {
  ...
  USER_MEDIA = `${BASE_PATH}${EndpointQuery.USER_MEDIA}/UserMedia`,
  USER_LIKES = `${BASE_PATH}${EndpointQuery.LIKES}/Likes`,
