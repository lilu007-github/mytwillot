...
import type { GridState, Relationship, SortState } from './types'
...
export const setRelationship = (relationship: Relationship) =>
  setGridState(
    produce((s) => {
...
export const setUsers = (users: StoredUser[]) => setGridState('users', users)
...
export const setError = (error: string | null) => setGridState('error', error)

export const refreshData = () =>
  setGridState('dataVersion', (v) => v + 1)
